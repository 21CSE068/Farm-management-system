...
<label for="pn">product name:</label>
 <input type="text" name="pn" value="sunflower seeds"><br><br>
<label for="pi">product id:</label>
 <input type="text" name="pi" value="107"><br><br>
...
<label>select the quantity: </label>
 ...
 <option value="150">(2)150rs</option>
 <option value="300">(3)300rs</option>
 <option value="500">(4)500rs</option>
 </select><br><br>
