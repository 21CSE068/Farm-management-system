...
<label for="pn">product name:</label>
 <input type="text" name="pn" value="maize"><br><br>
<label for="pi">product id:</label>
 <input type="text" name="pi" value="108"><br><br>
...
<label>select the quantity: </label>
 ...
 <option value="50">(1)50rs</option>
 <option value="60">(2)60rs</option>
 <option value="70">(3)70rs</option>
 <option value="80">(4)80rs</option>
 </select><br><br>
