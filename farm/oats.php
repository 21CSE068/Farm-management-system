...
<label for="pn">product name:</label>
 <input type="text" name="pn" value="oats"><br><br>
<label for="pi">product id:</label>
 <input type="text" name="pi" value="106"><br><br>
...
<label>select the quantity: </label>
 ...
 <option value="200">(1)200rs</option>
 <option value="450">(2)450rs</option>
 <option value="550">(3)550rs</option>
 <option value="700">(4)700rs</option>
 </select><br><br>
